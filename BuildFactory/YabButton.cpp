...
YabButton::YabButton(BRect frame,const char *name,const char *label,BMessage *message,uint32 resizeMask, uint32 flags) 
...
void YabButton::MouseDown(BPoint point)
{
	BPoint ptCursor;
	uint32 uButtons = 0;
...
void YabButton::MouseUp(BPoint point)
{
	BPoint ptCursor;
	uint32 uButtons = 0;
	GetMouse(&ptCursor, &uButtons, false); 
...
void YabButton::MouseMoved(BPoint point, uint32 transit, const BMessage *message)
{
	BPoint ptCursor;
	uint32 uButtons = 0;
